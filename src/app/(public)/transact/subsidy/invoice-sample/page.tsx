...
export const metadata: Metadata = {
  title: "適格請求書 出力サンプル｜電子取引Lシステム｜IT導入補助金 電子取引類型",
  description:
    "電子取引Lシステムが出力する適格請求書（インボイス）のサンプル。取引年月日・登録番号・税率別合計・税率別消費税額・適用税率等の必要記載事項を網羅。",
}
    ...
    <>
      ...
      <div className="print-hide sticky top-14 z-10 border-b border-slate-200 bg-white/95 backdrop-blur">
        <div className="mx-auto max-w-4xl flex items-center justify-between px-6 py-3">
          <Link href="/transact/subsidy" className="text-sm text-slate-600 hover:text-slate-900">
            ← 申請資料一覧に戻る
          </Link>
          <PrintButton />
        </div>
