...
export const metadata: Metadata = {
  title: "申請価格理由書｜電子取引Lシステム｜IT導入補助金 電子取引類型",
  description:
    "デジタル化・AI導入補助金2026 インボイス枠 電子取引類型 申請添付書類。電子取引Lシステムの標準販売価格の設定理由。",
}
...
export default function TransactPriceRationalePage() {
  return (
    <DocumentShell
      title="申請価格理由書"
    ...
    >
      ...
      <Section label="① IT導入支援事業者名">
        <p className="text-base">{PROVIDER_NAME}</p>
      </Section>
      ...
      <Section label="⑤ 最小販売価格の根拠">
        <p className="text-sm leading-relaxed">
          ...
          コア機能は標準プランと同等に提供します。
          なお、標準プランと最小プランの間には、招待企業数・取引件数上限を
          中規模事業者向けに設定したミドルプラン（年額 2,400,000円／月額 200,000円）を
          設けており、事業規模に応じた段階的なプラン選択が可能です
          （機能差はなく、いずれのプランも受注側企業への課金はありません）。
      ...
      <p className="mt-8 text-xs text-slate-500 leading-relaxed avoid-break">
        本書は、{SCHEME_LABEL} の交付申請において、IT導入支援事業者 {PROVIDER_NAME} が販売する
