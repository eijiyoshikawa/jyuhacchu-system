...
export const metadata: Metadata = {
  title: "適格請求書 出力サンプル｜受発注Lシステム｜IT導入補助金 申請書類",
  description:
    "受発注Lシステムが出力する適格請求書（インボイス）のサンプル。登録番号・税率別合計・税率別消費税額・適用税率等の必要記載事項を網羅。",
}
    ...
    <>
      ...
      <div className="print-hide mx-auto max-w-4xl px-6 pt-8">
        <div className="rounded border border-slate-200 bg-slate-50 p-4 text-sm leading-relaxed">
          <p className="font-bold mb-1">本ページについて</p>
          <p>
            本ページは、受発注Lシステムが出力する <strong>適格請求書（インボイス）のサンプル</strong>
            です。デジタル化・AI導入補助金2026 インボイス枠の申請時に求められる
