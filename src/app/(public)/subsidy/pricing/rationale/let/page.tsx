...
export const metadata: Metadata = {
  title: "申請価格理由書（LET版）｜受発注Lシステム｜IT導入補助金 申請書類",
  description:
    "デジタル化・AI導入補助金2026 インボイス枠 申請添付書類（株式会社LET 申請用）。受発注Lシステムの標準販売価格の設定理由を記載した申請価格理由書。",
}
...
export default function PriceRationaleDocumentLetPage() {
  return (
    <DocumentShell
      title="申請価格理由書"
    ...
    >
      ...
      <Section label="④ 価格設定の理由">
        ...
        <p className="text-sm leading-relaxed">
          ...
          セキュリティアップデート）が含まれます。本価格は
          <strong>ITツール登録要領 カテゴリー1（ソフトウェア）の単独申請</strong>
          として整理されており、その他カテゴリーの役務は本価格に含めていません。
        </p>
      ...
      <p className="mt-8 text-xs text-slate-500 leading-relaxed avoid-break">
        ...
        交付申請において、IT導入支援事業者 株式会社LET が販売する
