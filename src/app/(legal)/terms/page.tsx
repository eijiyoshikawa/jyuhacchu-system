      ...
      <div className="space-y-8 text-gray-700">
        <section>
          ...
          <p className="leading-relaxed">
            本利用規約（以下「本規約」といいます）は、当社が提供する建設業向け受発注管理システム（以下「本サービス」といいます）の利用条件を定めるものです。本サービスは、建設業における受発注業務のデジタル化を目的とし、発注・受注・請求・承認等のワークフローを電子的に管理することで、業務効率の向上を支援します。本サービスをご利用いただくすべてのユーザーは、本規約に同意したものとみなされます。
          </p>
        </section>
        ...
        <section>
          ...
          <ul className="list-disc space-y-2 pl-6">
            ...
            <li>
              <strong>「本サービス」</strong>とは、当社が提供する建設業向け受発注管理システムおよびこれに付随するすべてのサービスをいいます。
            </li>
            <li>
